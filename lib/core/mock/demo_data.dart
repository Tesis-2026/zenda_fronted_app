...
abstract final class DemoData {
  ...
  static final daySummary = const PeriodSummary(
    ...
    totalExpense: 8.50,
    netBalance: -8.50,
    topCategories: [TopCategoryItem(name: 'Comida', amount: 8.50)],
  );
  ...
  static const recommendations = <Recommendation>[
    Recommendation(
      ...
      body:
          'Tu presupuesto de comida está al 77% con S/ 116 gastados de S/ 150. Cocina en casa dos veces esta semana para no pasarte.',
      impactScore: 0.85,
    ...
    Recommendation(
      ...
      body:
          'No registraste ahorros este mes. Aparta S/ 50 hoy para empezar a construir tu fondo de emergencia.',
      impactScore: 0.90,
  ...
  static const educationTopics = <EducationTopic>[
    EducationTopic(
      ...
      content:
          'La regla 50/30/20 divide tus ingresos netos en tres bolsillos: 50% para necesidades, 30% para deseos y 20% para ahorro. Las necesidades incluyen alquiler, comida y servicios. Los deseos incluyen comer fuera, suscripciones y entretenimiento. El 20% restante va al ahorro y al pago de deudas.\n\nEste marco te ayuda a construir equilibrio financiero sin necesidad de rastrear cada gasto en detalle.',
    ...
    EducationTopic(
      ...
      content:
          'Un presupuesto realista parte de conocer tus ingresos reales y tus gastos fijos. Lista primero todo costo recurrente —alquiler, servicios, suscripciones— y luego calcula lo que queda. Asigna un monto fijo al gasto variable (comida, transporte) basándote en los datos del mes anterior.\n\nRevisa tu presupuesto semanalmente el primer mes para detectar desviaciones a tiempo. Cuando te excedas, ajusta los límites por categoría en lugar de abandonar el presupuesto por completo.',
      difficulty: 'Principiante',
      category: 'budgeting',
      order: 2,
      isCompleted: true,
    ...
    EducationTopic(
      ...
      content:
          'Un fondo de emergencia equivale a 3 a 6 meses de gastos esenciales guardados en una cuenta líquida. Cubre eventos inesperados —pérdida de empleo, gastos médicos, reparaciones urgentes— sin obligarte a endeudarte.\n\nEmpieza pequeño: S/ 50 al mes son S/ 600 en un año. Mantén el fondo separado de tu cuenta principal para reducir la tentación de gastarlo.',
    ...
    EducationTopic(
      ...
      content:
          'La constancia gana a los depósitos grandes pero esporádicos. Automatiza una transferencia al ahorro el día de pago —aunque sean S/ 20— antes de tener oportunidad de gastarlo. Este hábito de "págate primero a ti mismo" saca a la fuerza de voluntad de la ecuación.\n\nMide mensualmente tu tasa de ahorro (ahorro ÷ ingreso × 100). Una tasa del 10% es un buen punto de partida para estudiantes universitarios.',
      difficulty: 'Intermedio',
      category: 'saving',
      order: 4,
      isCompleted: false,
    ...
    EducationTopic(
      ...
      content:
          'Las tarjetas de crédito cobran intereses solo sobre los saldos no pagados. Pagar el saldo completo del estado de cuenta cada mes no te cuesta nada en intereses y construye tu historial crediticio.\n\nEl pago mínimo te atrapa en un ciclo de deuda —un saldo de S/ 500 pagado en mínimos puede tardar años en cancelarse. Apunta siempre a pagar más que el mínimo, idealmente el saldo completo.',
      difficulty: 'Intermedio',
      category: 'budgeting',
      order: 5,
      isCompleted: false,
    ...
    EducationTopic(
      ...
      content:
          'Invertir significa poner el dinero a trabajar para que crezca con el tiempo. Empieza por opciones de bajo riesgo: cuentas de ahorro, depósitos a plazo o bonos del gobierno. Conforme aprendas, considera fondos indexados —reparten el riesgo entre muchas empresas a bajo costo.\n\nEl tiempo en el mercado importa más que el momento exacto. Empezar con S/ 100 al mes a los 22 años supera a S/ 500 al mes a los 35 en el largo plazo.',
      difficulty: 'Avanzado',
      category: 'investing',
      order: 6,
      isCompleted: false,
  ...
  static const quizData = <String, List<_QuizEntry>>{
    'topic-1': [
      _QuizEntry(
        ...
        correctIndex: 1,
        explanation:
            'El 50 en 50/30/20 asigna la mitad de tus ingresos netos a necesidades esenciales como alquiler, comida y servicios.',
      ),
      _QuizEntry(
        id: 't1-q2',
        difficulty: 'Principiante',
        ...
        correctIndex: 2,
        explanation:
            'Una suscripción de streaming es discrecional (un deseo): puedes cancelarla sin afectar tus necesidades básicas.',
      ),
      _QuizEntry(
        id: 't1-q3',
        difficulty: 'Principiante',
        ...
        correctIndex: 2,
        explanation:
            'El 20% se reserva para construir ahorros y pagar deudas, lo que te ayuda a crecer tu patrimonio con el tiempo.',
      ),
      _QuizEntry(
        id: 't1-q4',
        difficulty: 'Principiante',
        text:
            'Con un ingreso mensual de S/ 2000, ¿cuánto debería ir al ahorro según la regla 50/30/20?',
        options: ['S/ 1000', 'S/ 600', 'S/ 400', 'S/ 200'],
        correctIndex: 2,
        explanation:
            'El 20% de S/ 2000 = S/ 400; ese es tu monto objetivo de ahorro mensual bajo la regla 50/30/20.',
      ),
    ],
    'topic-2': [
      _QuizEntry(
        ...
        correctIndex: 2,
        explanation:
            'Los costos fijos como alquiler, servicios y suscripciones son predecibles y deben cubrirse cada mes, por eso anclan tu presupuesto.',
      ),
      _QuizEntry(
        id: 't2-q2',
        difficulty: 'Principiante',
        text:
            '¿Con qué frecuencia debes revisar tu presupuesto en el primer mes?',
        options: ['Diario', 'Semanal', 'Mensual', 'Trimestral'],
        correctIndex: 1,
        explanation:
            'Las revisiones semanales del primer mes te ayudan a detectar excesos a tiempo y ajustar antes de que termine el mes.',
      ),
      _QuizEntry(
        id: 't2-q3',
        difficulty: 'Principiante',
        ...
        options: [
          ...
          'Tomar prestado del próximo mes',
          'Ajustar el límite de la categoría',
          'Ignorarlo',
        ],
        correctIndex: 2,
        explanation:
            'Ajustar el límite con datos reales hace que tu presupuesto sea más preciso y sostenible en el tiempo.',
      ),
      _QuizEntry(
        id: 't2-q4',
        difficulty: 'Principiante',
        text:
            '¿Qué fuente de datos es más útil para asignar el gasto variable?',
        options: [
          'Los gastos de un amigo',
          'Calculadoras en línea',
          'Tu gasto real del mes anterior',
          'Tu tasa de impuestos',
        ],
        correctIndex: 2,
        explanation:
            'Tu propio gasto pasado es la línea base más precisa porque refleja tus hábitos personales y costo de vida.',
      ),
    ],
    'topic-3': [
      _QuizEntry(
        ...
        correctIndex: 1,
        explanation:
            'De 3 a 6 meses te da suficiente colchón para enfrentar pérdida de empleo o emergencias médicas sin endeudarte.',
      ),
      _QuizEntry(
        id: 't3-q2',
        difficulty: 'Intermedio',
        ...
        options: [
          ...
          'Cuenta de ahorro líquida',
          'Depósito a plazo fijo',
        ],
        correctIndex: 2,
        explanation:
            'Una cuenta líquida te permite acceder al dinero de inmediato en una emergencia, sin penalidades ni esperas.',
      ),
      _QuizEntry(
        id: 't3-q3',
        difficulty: 'Intermedio',
        ...
        options: [
          ...
          'Cubrir costos imprevistos sin endeudarse',
          'Pagar las cuentas regulares',
          'Financiar viajes de vacaciones',
        ],
        correctIndex: 1,
        explanation:
            'Un fondo de emergencia actúa como colchón financiero para que los imprevistos no te empujen a deudas con altos intereses.',
      ),
      _QuizEntry(
        id: 't3-q4',
        difficulty: 'Intermedio',
        ...
        correctIndex: 1,
        explanation:
            'S/ 50 × 12 meses = S/ 600; los depósitos pequeños y constantes se acumulan de forma significativa en un año.',
      ),
    ],
    'topic-4': [
      _QuizEntry(
        ...
        options: [
          'Gastar en ti antes que en las cuentas',
          'Ahorrar antes de gastar',
          'Invertir el 50% del ingreso',
          'Pagar deudas primero',
        ],
        correctIndex: 1,
        explanation:
            'Ahorrar antes de gastar saca la fuerza de voluntad de la ecuación: tu transferencia al ahorro ocurre automáticamente el día de pago.',
      ),
      _QuizEntry(
        id: 't4-q2',
        difficulty: 'Intermedio',
        ...
        correctIndex: 1,
        explanation:
            'Transferir el día de pago hace que el ahorro ocurra antes del gasto discrecional, asegurando que siempre apartes algo.',
      ),
      _QuizEntry(
        id: 't4-q3',
        difficulty: 'Intermedio',
        text:
            'Una tasa de ahorro inicial sólida para estudiantes universitarios es:',
        options: ['5%', '20%', '10%', '30%'],
        correctIndex: 2,
        explanation:
            'Una tasa del 10% es alcanzable con un ingreso estudiantil y construye el hábito de ahorrar sin restringir demasiado el gasto.',
      ),
      _QuizEntry(
        id: 't4-q4',
        difficulty: 'Intermedio',
        ...
        correctIndex: 2,
        explanation:
            'Tasa de ahorro = (monto ahorrado ÷ ingreso total) × 100; dividir entre el ingreso muestra qué fracción de tus ganancias conservas.',
      ),
    ],
    'topic-5': [
      _QuizEntry(
        ...
        options: [
          'En cada compra',
          'Solo en avances de efectivo',
          'Sobre saldos no pagados',
          'Cada mes sin importar nada',
        ],
        correctIndex: 2,
        explanation:
            'Los intereses se cobran solo sobre el saldo que mantengas después de la fecha de pago; pagar el total cada mes implica cero intereses.',
      ),
      _QuizEntry(
        id: 't5-q2',
        difficulty: 'Intermedio',
        ...
        options: [
          ...
          'Pagar la mitad del saldo',
          'Saltarse un mes',
        ],
        correctIndex: 1,
        explanation:
            'Pagar el saldo total elimina los intereses y construye un historial crediticio positivo sin costo extra.',
      ),
      _QuizEntry(
        id: 't5-q3',
        difficulty: 'Intermedio',
        ...
        correctIndex: 2,
        explanation:
            'Los pagos mínimos apenas cubren los intereses, así que el capital casi no baja, atrapándote en un ciclo de deuda lento y caro.',
      ),
      _QuizEntry(
        id: 't5-q4',
        difficulty: 'Intermedio',
        ...
        options: [
          ...
          'Cero intereses y mejora tu historial',
          'Pagos mínimos más bajos',
        ],
        correctIndex: 2,
        explanation:
            'Pagar el total evita los intereses por completo y los pagos a tiempo construyen tu historial crediticio con el tiempo.',
      ),
    ],
    'topic-6': [
      _QuizEntry(
        ...
        correctIndex: 1,
        explanation:
            'Los bonos del gobierno están respaldados por el Estado y ofrecen rendimientos predecibles, siendo el punto de partida más seguro para nuevos inversores.',
      ),
      _QuizEntry(
        id: 't6-q2',
        difficulty: 'Avanzado',
        ...
        options: [
          ...
          'Riesgo diversificado a bajo costo',
          'Sin impuestos sobre las ganancias',
          'Acceso exclusivo',
        ],
        correctIndex: 1,
        explanation:
            'Los fondos indexados reparten el riesgo entre cientos de empresas automáticamente y cobran comisiones muy bajas comparadas con los fondos activos.',
      ),
      _QuizEntry(
        id: 't6-q3',
        difficulty: 'Avanzado',
        ...
        options: [
          'Operar en el momento correcto',
          'Day trading',
          'Mantener inversiones a largo plazo',
          'Adivinar las caídas del mercado',
        ],
        correctIndex: 2,
        explanation:
            'Mantener inversiones a largo plazo deja que el interés compuesto trabaje, lo cual supera consistentemente a intentar adivinar los movimientos del mercado.',
      ),
      _QuizEntry(
        id: 't6-q4',
        difficulty: 'Avanzado',
        text:
            '¿Por qué empezar a invertir a los 22 años gana frente a empezar a los 35 (aun con menos al mes)?',
        options: [
          'Aportes más altos',
          'Más años de crecimiento compuesto',
          'Impuestos más bajos',
          'Mayor tolerancia al riesgo',
        ],
        correctIndex: 1,
        explanation:
            'Más años de capitalización significan que cada aporte temprano crece exponencialmente por más tiempo, generando un saldo final mucho mayor.',
      ),
    ],
  };
  ...
  static const aiChatResponses = <String, String>{
    'budget':
        'Según tu gasto de este mes, tu presupuesto de comida está al 77% con S/ 116 gastados de un límite de S/ 150. Cocina en casa 2 o 3 veces esta semana para mantenerte en rumbo. Tu entretenimiento y suscripciones están bien dentro de los límites.',
    'save':
        'Has ahorrado S/ 0 este mes hasta ahora. Un gran primer paso es automatizar una transferencia de S/ 100 el día de pago, antes de que puedas gastarlo. Incluso S/ 50 al mes son S/ 600 al año para tu fondo de emergencia.',
    'goal':
        'Tu Fondo de Emergencia está al 28% (S/ 850 de S/ 3000). Al ritmo actual, lo alcanzarás en diciembre de 2026. Aportar S/ 200 más al mes te permitiría llegar a la meta 3 meses antes.',
    'invest':
        'Para principiantes, recomiendo empezar con una cuenta de ahorro o bonos de bajo riesgo antes de pasar a fondos indexados. El tiempo en el mercado le gana al timing del mercado: incluso S/ 100 al mes a los 22 años se capitaliza significativamente para los 30.',
    'spend':
        'Tus principales categorías de gasto este mes: Salud S/ 120, Comida S/ 116, Compras S/ 90, Servicios S/ 79. Salud y comida están cerca de su límite. Te sugiero revisar tu membresía del gimnasio si no la estás usando con regularidad.',
    'debt':
        'Paga siempre el saldo total de tu tarjeta de crédito cada mes para evitar intereses. Tu Crédito Visa tiene S/ 1150 disponibles, eso es bueno; mantén la utilización por debajo del 30% para proteger tu score crediticio.',
    'analyze':
        '¡Tus finanzas se ven saludables este mes! Ingreso: S/ 1200, Gasto: S/ 481, Neto: S/ 719. Estás ahorrando el 60% de tu ingreso, excelente para un estudiante universitario. Tu mayor área de riesgo es el gasto en comida, que se acerca al presupuesto.',
    'default':
        '¡Excelente pregunta financiera! Según tus patrones de gasto actuales, te recomiendo enfocarte primero en construir tu fondo de emergencia y luego trabajar tus metas de ahorro. ¿Quieres que analice un área específica de tus finanzas?',
  };
  ...
  static final challenges = <Challenge>[
    const Challenge(
      ...
      description:
          'No compres café por 5 días seguidos y ahorra esos S/ 8.50 al día.',
      pointsReward: 75,
      status: 'ACTIVE',
      progressCurrent: 3,
      progressTotal: 5,
    ...
    const Challenge(
      ...
      description:
          'Mantén todas tus categorías de presupuesto activas en rumbo durante todo el mes.',
      pointsReward: 100,
      status: 'ACTIVE',
      progressCurrent: 2,
      progressTotal: 3,
    ...
    const Challenge(
      ...
      description:
          'Registra al menos una transacción cada día durante 7 días consecutivos.',
      pointsReward: 60,
      status: 'AVAILABLE',
      progressCurrent: 0,
      progressTotal: 7,
  ...
  static final badges = <ZendaBadge>[
    ...
    ZendaBadge(
      ...
      description:
          'Completaste tu primera encuesta de alfabetización financiera.',
      isEarned: true,
    ...
    ZendaBadge(
      ...
      description:
          'Mantente debajo de todos tus presupuestos durante un mes entero.',
      isEarned: false,
    ),
    ZendaBadge(
      id: 'badge-5',
      ...
      description:
          'Completa cualquier meta de ahorro antes de su fecha límite.',
      isEarned: false,
    ),
    ZendaBadge(
      id: 'badge-6',
    ...
    questions: [
      ...
      const SurveyQuestion(
        ...
        options: [
          ...
          'La conozco a grandes rasgos',
          'La aplico regularmente',
        ],
      ),
      const SurveyQuestion(
        id: 'sq-5',
  ...
  static final apiTransactions = transactions
      .map(
        (tx) => <String, dynamic>{
          ...
          'category': <String, dynamic>{'name': _categoryApiName(tx.category)},
        },
      )
      .toList();
  ...
  static String _categoryApiName(TransactionCategory cat) => switch (cat) {
    ...
    TransactionCategory.beca => 'Beca',
    TransactionCategory.trabajoPartTime => 'Trabajo part-time',
    TransactionCategory.familia => 'Apoyo familiar',
